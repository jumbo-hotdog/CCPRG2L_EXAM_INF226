...
public class Regex {
    public static void main(String[] args) {
        ...
        // Provide the pattern
        pattern = Pattern.compile("^((?!.*G|g|M|m|B|b|L|l|T|t).){11,}\\d$");
        ...
        pattern = Pattern.compile("^\\w(?=.*4)(?=.*2)((?![@$!^%*#?&~()+=\\-\\\\/<>,]).){10,}@ymail\\.com$");
        ...
        // Provide regex pattern
        pattern = Pattern.compile("^((http(s)?):\\/\\/www\\.|(http(s)?):\\/\\/|www\\.)(joshuaguimbaolibot)\\.com(\\/[-a-zA-Z0-9@:%_\\\\+.~#?&/=]*)?$|^((http(s)?):\\/\\/www\\.|(http(s)?):\\/\\/|www\\.)(127\\.0\\.0\\.1)(\\/\\w*)?(-)?(\\w*)?$");
        ...
        // Provide the regex pattern
        tweet = tweet.replaceAll("http:\\/\\/\\w+.\\w+\\/\\w+", " ");
